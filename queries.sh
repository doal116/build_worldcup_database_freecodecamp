...
echo "$($PSQL "SELECT games.year, name FROM teams FULL JOIN games ON teams.team_id=games.winner_id WHERE round='Final' AND (year=2014 OR year=2018) ORDER BY year")"
